...
def content_sql_injection(numero_seleccion):#Contenido de sql injection
    if(numero_seleccion=="con" or numero_seleccion=="CON"):
        ...
        archivo_en_descarga=input("¿Ver script del ataque?(Utilizarlo cuando se llegue al paso) s/n: ")
        if archivo_en_descarga=="s":
            print("**********************************************************************************")        
            ...
            print("         Step #6.2.1.3: Modificar script a beneficio.(Utilizar el Script anexado al inicio)")
