#Tareas:
#   1. Vamos para la decimo tercera en la documentación o onceava del código
...
def menu_interno(numero_seleccion):#Menu para la seleccion despues de cada ataque
    if(numero_seleccion == "CON" or numero_seleccion == "con" or numero_seleccion == "DIC" or numero_seleccion == "dic" or numero_seleccion == "A" or numero_seleccion == "a" ):
        print()
        print("--------------------------------------------------------------------")        
...
def content_sql_injection(numero_seleccion):#Contenido de sql injection
    if(numero_seleccion=="con" or numero_seleccion=="CON"):
        ...
        print(" result #1: No debe funcionar")
        print(" result #2: Debe desaparecer el contenido de la página.")
        ...
        print("         Step #6.2.1.3: Modificar script a beneficio, Utilizar el Script attack_10.py que se encuentra en la carpeta Script_sql_injection.(recomiendo hacer una copia del archivo)")
        print("         Step #6.2.1.4: Atacar ejecutando el archivo python [python3 attack_10.py]")
        print("         Step #6.2.1.5: Recaudar la información recolectada")
        print("Step #7: Loguearnos con los datos robados")
        print("--------------------------------------------------------------------------")
        print("EXPLICACIÓN POR PARTES:")
        print("[']: Para hacer un hueco.")
        print("[1=1]: Se busca un TRUE por lo cual logicamente 1 es igual a 1.")
        ...
        print("**********************************************************************************")
        print("#11: SQL INJECTION A CIEGAS CON TIEMPO DE RETRASO")
        print()
        print("DESCRIPTION: ")
        print("--------------------------------------------------------------------------")
        print("EXPLICACIÓN POR PARTES:")
...
def sql_injection_menu():#Menu interactivo del ataque de sql inyections
    ...
    print("HIT #11: SQL INJECTION A CIEGAS CON TIEMPO DE RETRASO")
